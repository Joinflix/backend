...
VALUES
-- 친구 신청 알림
(2, 'test님이 친구 신청을 하였습니다.', NOW(), NOW()),          -- 1 → 2
(1, '박민수님이 친구 신청을 하였습니다.', NOW(), NOW()),        -- 4 → 1

-- 친구 수락 알림
(1, '김철수님이 친구 신청을 수락하였습니다.', NOW(), NOW()),     -- 2 → 1
(2, '이영희님이 친구 신청을 수락하였습니다.', NOW(), NOW()),     -- 3 → 2

-- 파티 초대 알림
(2, 'test님이 김철수님을 \'흥미진진\' 파티에 초대했습니다.', NOW(), NOW()),   -- 방 1
(3, '김철수님이 이영희님을 \'재밌겠다\' 파티에 초대했습니다.', NOW(), NOW()), -- 방 2
(1, '정우성님이 test님을 \'같이 영화봐요\' 파티에 초대했습니다.', NOW(), NOW()); -- 방 3